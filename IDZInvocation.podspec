#
#  Be sure to run `pod spec lint IDZInvocation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
		   There seems little purpose in recreating the github README.md here.
                   DESC
  ...
  # Or just: s.author    = "idz"
  # s.authors            = { "idz" => "idz@iosdeveloperzone.com" }
  # s.social_media_url   = "http://twitter.com/idz"
